...
public class Form5 extends Frame {
    ...
    public Form5() {
        setLayout(null);
        setSize(800, 600);
        setBackground(Color.PINK);  // Set background color of the frame to pink
        setButton(Color.BLUE);  // Set button color to blue
        setText(Color.RED);  // Set text color to red
        setTitle("Fa Shop");
        ...
        lblId.setForeground(Color.RED);  // Set label text color to red
        add(lblId);
        ...
        lblName.setForeground(Color.RED);  // Set label text color to red
        add(lblName);
        ...
        lblPrice.setForeground(Color.RED);  // Set label text color to red
        add(lblPrice);
        ...
        lblDiscount.setForeground(Color.RED);  // Set label text color to red
        add(lblDiscount);
        ...
        // Button Panel with FlowLayout (flexible buttons, no space between them)
        Panel buttonPanel = new Panel();
        buttonPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 0, 0)); // Align to left with no space between buttons
        buttonPanel.setBounds(formCenter - 300, 300, 320, 40); // Panel for buttons

        // Add buttons to the panel and set their preferred size
    ...
    private void setText(Color color) {
        ...
        lblDiscount.setForeground(color);
    }
}
